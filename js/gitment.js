...
var NOT_INITIALIZED_ERROR = exports.NOT_INITIALIZED_ERROR = new Error('评论未初始化，请通知管理员');
...
function renderHeader(_ref, instance) {
  ...
  likeButton.innerHTML = '\n    ' + _icons.heart + '\n    ' + (likedReaction ? '取消点赞' : '点赞') + '\n    ' + (meta.reactions && meta.reactions.heart ? ' \u2022 <strong>' + meta.reactions.heart + '</strong> 次点赞' : '') + '\n  ';
  ...
  issueLink.innerText = '到 Issue 页面评论(更安全)';
...
function renderEditor(_ref3, instance) {
  ...
  var disabledTip = user.login ? '' : '要评论请登录Github';
  container.innerHTML = '\n      ' + (user.login ? '<a class="gitment-editor-avatar" href="' + user.html_url + '" target="_blank">\n            <img class="gitment-editor-avatar-img" src="' + user.avatar_url + '"/>\n          </a>' : user.isLoggingIn ? '<div class="gitment-editor-avatar">' + _icons.spinner + '</div>' : '<a class="gitment-editor-avatar" href="' + instance.loginLink + '" title="login with GitHub">\n              ' + _icons.github + '\n            </a>') + '\n    </a>\n    <div class="gitment-editor-main">\n      <div class="gitment-editor-header">\n        <nav class="gitment-editor-tabs">\n          <button class="gitment-editor-tab gitment-selected">编辑</bu</button>\n          <button class="gitment-editor-tab">预览</button>\n        </nav>\n        <div class="gitment-editor-login">\n          ' + (user.login ? '<a class="gitment-editor-logout-link">登出</a>' : user.isLoggingIn ? '正在登录...' : '使用Github<a class="gitment-editor-login-link" href="' + instance.loginLink + '">登录</a>') + '\n        </div>\n      </div>\n      <div class="gitment-editor-body">\n        <div class="gitment-editor-write-field">\n          <textarea placeholder="说说你的看法吧~" title="' + disabledTip + '" ' + shouldDisable + '></textarea>\n        </div>\n        <div class="gitment-editor-preview-field gitment-hidden">\n          <div class="gitment-editor-preview gitment-markdown"></div>\n        </div>\n      </div>\n    </div>\n    <div class="gitment-editor-footer">\n      <a class="gitment-editor-footer-tip" href="https://guides.github.com/features/mastering-markdown/" target="_blank">\n        支持使用Markdown编辑\n      </a>\n      <button class="gitment-editor-submit" title="' + disabledTip + '" ' + shouldDisable + '>发布</button>\n    </div>\n  ';
  if (user.login) {
  ...
  previewTab.onclick = function () {
    ...
    if (!content) {
      preview.innerText = '什么都没有写呢,写点东西吧~~~';
      return;
    }
...
function renderFooter() {
  var container = document.createElement('div');
  container.lang = "zh-cmn-Hans";
  container.className = 'gitment-container gitment-footer-container';
  container.innerHTML = '\n    由\n    <a class="gitment-footer-project-link" href="https://github.com/imsun/gitment" target="_blank">\n      Gitment\n         </a>\n      强力驱动\n          ·\n        \n    <a class="gitment-footer-editor-link" href="https://blog.teages.xyz" target="_blank">\n      Teages\n         </a>\n      汉化\n';
  return container;
}
